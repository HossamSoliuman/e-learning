                                ...
                                <form action="{{ route('admin.counter-section.update', 1) }}" method="post"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="total_student">{{ __('Total Students') }}<span class="text-danger"></span></label>
                                            <input data-translate="true" type="text" id="total_student"
                                                name="total_student_count"
                                                value="{{ $counter?->total_student_count }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="total_instructors">{{ __('Total Instructors') }}<span class="text-danger"></span></label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="total_courses">{{ __('Total Courses') }}<span class="text-danger"></span></label>
                                            <input data-translate="true" type="text" id="total_courses"
                                                name="total_courses_count"
                                                value="{{ $counter?->total_courses_count }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="total_awards">{{ __('Total Awards') }}<span class="text-danger"></span></label>
                                            <input data-translate="true" type="text" id="total_awards"
                                                name="total_awards_count"
                                                value="{{ $counter?->total_awards_count }}"
