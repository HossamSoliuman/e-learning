                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="sub_title">{{ __('Sub Title') }}<span
                                                        class="text-danger"> ({{ __('leave blank for hide') }})</span></label>
...
@push('js')
    ...
    <script>
        ...
        @if (Cache::get('setting')?->site_theme == 'theme-one')
            $('#image-preview').css({
                'background-image': 'url({{ asset($heroSection->banner_image) }})',
                'background-size': 'contain',
                'background-position': 'center',
                'background-repeat': 'no-repeat'
            });
            $('#image-preview-2').css({
                'background-image': 'url({{ asset($heroSection->banner_background) }})',
                'background-size': 'contain',
                'background-position': 'center',
                'background-repeat': 'no-repeat'
            });
            $('#image-preview-3').css({
                'background-image': 'url({{ asset($heroSection->hero_background) }})',
                'background-size': 'contain',
                'background-position': 'center',
                'background-repeat': 'no-repeat'
            });
        @elseif (Cache::get('setting')?->site_theme == 'theme-two')
            $('#image-preview').css({
                'background-image': 'url({{ asset($heroSection->h_two_banner_image) }})',
                'background-size': 'contain',
                'background-position': 'center',
                'background-repeat': 'no-repeat'
            });
            $('#image-preview-2').css({
                'background-image': 'url({{ asset($heroSection->h_two_banner_background) }})',
                'background-size': 'contain',
                'background-position': 'center',
                'background-repeat': 'no-repeat'
            });
            $('#image-preview-3').css({
                'background-image': 'url({{ asset($heroSection->h_two_hero_background) }})',
                'background-size': 'contain',
                'background-position': 'center',
                'background-repeat': 'no-repeat'
            });
