...
trait GetGlobalInformationTrait
{
    ...
    private function calculate_payable_charge($payable_amount, $gateway_name)
    {
        ...
        if ($gateway_name == 'stripe') {
            ...
            $gateway_currency = allCurrencies()->where('id', $basic_payment->stripe_currency_id)->first();
            ...
            $basic_payment = $this->get_basic_payment_info();
            $gateway_currency = allCurrencies()->where('id', $basic_payment->paypal_currency_id)->first();
            $currency_code = $gateway_currency->currency_code;
            $country_code = $gateway_currency->country_code;
            ...
            $gateway_currency = allCurrencies()->where('id', $payment_setting->razorpay_currency_id)->first();
            $currency_code = $gateway_currency->currency_code;
            $country_code = $gateway_currency->country_code;
            ...
            $payment_setting = $this->get_payment_gateway_info();
            $gateway_currency = allCurrencies()->where('id', $payment_setting->mollie_currency_id)->first();
            $currency_code = $gateway_currency->currency_code;
            $country_code = $gateway_currency->country_code;
            ...
            $payment_setting = $this->get_payment_gateway_info();
            $gateway_currency = allCurrencies()->where('id', $payment_setting->instamojo_currency_id)->first();
            $currency_code = $gateway_currency->currency_code;
            $country_code = $gateway_currency->country_code;
            ...
            $payment_setting = $this->get_payment_gateway_info();
            $gateway_currency = allCurrencies()->where('id', $payment_setting->flutterwave_currency_id)->first();
            $currency_code = $gateway_currency->currency_code;
            $country_code = $gateway_currency->country_code;
            ...
            $payment_setting = $this->get_payment_gateway_info();
            $gateway_currency = allCurrencies()->where('id', $payment_setting->paystack_currency_id)->first();
            $currency_code = $gateway_currency->currency_code;
            $country_code = $gateway_currency->country_code;
