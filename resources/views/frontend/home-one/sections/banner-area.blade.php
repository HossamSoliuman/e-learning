<section class="banner-area banner-bg tg-motion-effects" data-background="{{ asset($hero->hero_background) }}">
    <div class="container">
        <div class="row justify-content-between align-items-start">
            ...
            <div class="col-lg-6">
                <div class="banner__images">
                    <img src="{{ asset($hero->banner_image) }}" alt="img" class="main-img">
                    <div class="shape big-shape" data-aos="fade-up-right" data-aos-delay="600">
                        <img src="{{ asset($hero->banner_background) }}" alt="shape" class="tg-motion-effects1">
                    </div>
