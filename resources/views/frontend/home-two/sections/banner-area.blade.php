<section class="banner-area-two banner-bg-two tg-motion-effects" data-background="{{ asset($hero->h_two_hero_background) }}">
      ...
      <div class="row justify-content-center">
          ...
          <div class="col-xl-7 col-lg-6 col-md-8">
              <div class="banner__images-two tg-svg">
                  <img src="{{ asset($hero->h_two_banner_image) }}" alt="img" class="main-img">
                  <div class="shape big-shape" data-aos="fade-up" data-aos-delay="600">
                      <img src="{{ asset($hero->h_two_banner_background) }}" alt="shape"
