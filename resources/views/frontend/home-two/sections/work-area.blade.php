        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 col-md-9">
                <div class="about__images">
                    <img src="{{ asset($aboutSection->image) }}" alt="img" class="main-img">
                    <img src="{{ asset('frontend/img/others/about_shape.svg') }}" alt="img" class="shape alltuchtopdown">
                    <a href="{{ $aboutSection->video_url}}" class="popup-video">
            ...
            <div class="col-lg-6">
                <div class="about__content">
                    ...
                    <div class="tg-button-wrap">
                        <a href="{{ $aboutSection->button_url }}" class="btn arrow-btn">{{ $aboutSection->translation?->button_text }} <img
