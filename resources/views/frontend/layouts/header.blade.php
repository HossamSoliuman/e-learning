                ...
                <div class="col-lg-6">
                    <ul class="tg-header__top-info list-wrap">
                        <li><img src="{{ asset('frontend/img/icons/map_marker.svg') }}" alt="Icon">
                            <span>{{ Cache::get('setting')->site_address }}</span>
                        </li>
                        <li><img src="{{ asset('frontend/img/icons/envelope.svg') }}" alt="Icon"> <a
                                href="mailto:{{ Cache::get('setting')->site_email }}">{{ Cache::get('setting')->site_email }}</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-6">
                                ...
                                @if ($nav_menu)
                                    <ul class="navigation">
                                        @foreach ($nav_menu as $menu)
                                            @if ($menu['link'] == '/' && Cache::get('setting')->show_all_homepage == 1)
